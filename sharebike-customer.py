...
#rent fuction
def rent_button():
    rent_window = importlib.import_module("sharebike-customer-rent")


# return fuction
def return_button():
    return_window = importlib.import_module("sharebike-customer-return")


# report fuction
def report_button():
    report_window = importlib.import_module("sharebike-customer-report")


# pay function
def pay_button():
    report_window = importlib.import_module("sharebike-customer-pay")
